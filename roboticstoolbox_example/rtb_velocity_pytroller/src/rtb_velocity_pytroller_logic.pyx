...
include "../script/rtb_velocity_pytroller_logic_impl.py"

include "rtb_velocity_pytroller_parameters.pxd"
...
cdef public int rtb_velocity_pytroller_logic(unordered_map[string, double] states, unordered_map[string, double] & commands, vector[int] & msg, Params param):
  try:
