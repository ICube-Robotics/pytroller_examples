...
#ifndef TEST_RTB_VELOCITY_PYTROLLER_HPP_
#define TEST_RTB_VELOCITY_PYTROLLER_HPP_
...
class FriendRtbVelocityPytroller : public rtb_velocity_pytroller::RtbVelocityPytroller
{
  FRIEND_TEST(TestRtbVelocityPytroller, CommandSuccessTest);
  FRIEND_TEST(TestRtbVelocityPytroller, WrongCommandCheckTest);
  FRIEND_TEST(TestRtbVelocityPytroller, CommandSuccessTestWithConstraints);
};

class TestRtbVelocityPytroller : public ::testing::Test
{
public:
...
protected:
  std::unique_ptr<FriendRtbVelocityPytroller> controller_;
