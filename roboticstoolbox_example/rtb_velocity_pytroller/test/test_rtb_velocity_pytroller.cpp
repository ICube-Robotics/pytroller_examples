...
#include "test_rtb_velocity_pytroller.hpp"
...
void TestRtbVelocityPytroller::SetUpTestCase() { rclcpp::init(0, nullptr); }

void TestRtbVelocityPytroller::TearDownTestCase() { rclcpp::shutdown(); }

void TestRtbVelocityPytroller::SetUp()
{
  controller_ = std::make_unique<FriendRtbVelocityPytroller>();
}

void TestRtbVelocityPytroller::TearDown() { controller_.reset(nullptr); }

void TestRtbVelocityPytroller::SetUpController()
{
  const auto result = controller_->init("test_rtb_velocity_pytroller");
...
TEST_F(TestRtbVelocityPytroller, ConfigureAndActivateParamsSuccess)
{
  SetUpController();
...
TEST_F(TestRtbVelocityPytroller, NoCommandCheckTest)
{
  SetUpController();
